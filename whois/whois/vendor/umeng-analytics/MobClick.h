...
//  Version 2.0 , updated_at 2012-02-23.
...
+ (void)start:(NSString *)appKey reportPolicy:(ReportPolicy)rp channelId:(NSString *)cid;
...
+ (void)endEvent:(NSString *)newEvent_id label:(NSString *)newLabel;
