...
- (ASIFormDataRequest *) postRequest:(NSDictionary *)args{
    ...
    [request addRequestHeader:@"Referer" value:@"http://pasent.com/"];
...
- (void) asyncRequest:(NSDictionary *)args{
    //NSString *url = [NSString stringWithFormat:@"%@%@",base_url,@"hot.php"];
    APIRequest *request = [APIRequest requestWithURL:[NSURL URLWithString:[args objectForKey:@"url"]]];
    [request addRequestHeader:@"Referer" value:@"http://pasent.com/"];
